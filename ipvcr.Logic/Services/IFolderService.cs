...
public interface IFolderService
{
    ...
    /// <exception cref="System.UnauthorizedAccessException">Thrown when attempting to access a path outside the media directory</exception>
    ...
    /// <exception cref="System.ArgumentException">Thrown when folder name is invalid</exception>
    /// <exception cref="System.UnauthorizedAccessException">Thrown when attempting to create a folder outside the media directory</exception>
    /// <exception cref="System.IO.IOException">Thrown when the folder already exists</exception>
